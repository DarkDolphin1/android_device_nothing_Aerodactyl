...
persist.vendor.audio.fpsop.game.effect=true
persist.vendor.audio.game.effect.version=2
persist.vendor.audio.misound.disable=true
persist.vendor.audio.power.save.setting=47
persist.vendor.audio.ringtone.bcl=false
...
ro.odm.mm.vibrator.sys_f0_path=sys/bus/i2c/drivers/awinic_haptic/1-005a/f0_value
ro.odm.mm.vibrator.si_sys_f0_path=sys/bus/i2c/drivers/sih_haptic_688X/0-006b/f0_value
ro.odm.mm.vibrator.aac_sys_f0_path=sys/bus/i2c/drivers/haptic_rt/0-005f/f0_value
ro.vendor.audio.camera_gain=true
ro.vendor.audio.dolby.dax.support=true
ro.vendor.audio.gain.support=true
ro.vendor.audio.media.volume.steps=30
ro.vendor.audio.meeting.mode=true
ro.vendor.audio.offload_to_music=true
ro.vendor.audio.reverse_mic=true
ro.vendor.audio.soundtrigger.support_record_type=0x0011
ro.vendor.audio.voiceassist.support_record_type=0x0002
vendor.audio.gamevoice=1
vendor.audio.misound.bypass=true
...
# AVF
avf.remote_attestation.enabled=0
...
persist.vendor.camera.mialgo.tracegroups=31
...
persist.vendor.mifaced.fastlaunch=1
...
vendor.debug.camera.p1.enable_systrace_log=1
vendor.debug.camera.ulog.mode=0x11
vendor.debug.camera.ulog.filter=0xfffff
vendor.debug.camera.ulog.func=1
vendor.debug.hal3av3.systrace=1
...
debug.sf.early.sf.duration=12300000
debug.sf.earlyGl.app.duration=11600000
debug.sf.earlyGl.sf.duration=12300000
...
ro.surface_flinger.uclamp.min=328
ro.vendor.mtk.gpu.service=1
vendor.dp.systrace.enable=1
...
ro.vendor.fingerprint.sensor_location=535|2413|210
...
ro.vendor.arm.egl.configs.r8_g8_b8_a0_24bit_fixed.hal_format=0x3
...
ro.vendor.arm.egl.configs.q410.hal_format=0x20a
...
ro.vendor.arm.gralloc.afrc_rgba_usage_flags=0x1400000000000000,0x1200000000000000,0x1000000000000000
ro.vendor.arm.gralloc.afrc_rgba_usage_mask=0x1600000000000000
ro.vendor.arm.gralloc.afrc_luma_usage_flags=0x1400000000000000,0x1200000000000000,0x1000000000000000
ro.vendor.arm.gralloc.afrc_luma_usage_mask=0x1600000000000000
...
vendor.mtk.c2.venc.async.systrace=1F
vendor.mtk.vdec.decode.error.handle.mode=3
...
# Netflix
ro.netflix.bsp_rev=MT6899-39863-1
...
persist.vendor.sys.pq.oddmr_dbi_support=0
ro.vendor.hdr10plus.enable=1
ro.vendor.mml.mtk_mml_support=1
ro.vendor.mtk_airegionpq_adaptive_support=1
...
ro.vendor.mtk_hdr10_adaptive_support=1
ro.vendor.mtk_hdr10p_adaptive_support=1
ro.vendor.mtk_hdrvivid_adaptive_support=0
ro.vendor.mtk_hlg_adaptive_support=0
ro.vendor.mtk_ovl_bringup=0
ro.vendor.mtk_pq_color_mode=3
ro.vendor.mtk_pq_support=2
ro.vendor.mtk_sdr_adaptive_support=0
ro.vendor.pq.mtk_aal_support=1
ro.vendor.pq.mtk_ai_hdr_model_dq=0.006186207290738821
ro.vendor.pq.mtk_ai_scence_pq_support=0
ro.vendor.pq.mtk_ai_sdr_to_hdr_support=0
ro.vendor.pq.mtk_ai_region_pq_support=1
ro.vendor.pq.mtk_airegionpq_panel_dtmo_support=1
...
ro.vendor.pq.mtk_dre_cap=0x3
ro.vendor.pq.mtk_dre30_support=1
ro.vendor.pq.mtk_ds_support=1
ro.vendor.pq.mtk_hdr10_panel_dtmo_support=1
ro.vendor.pq.mtk_hdr10_plus_recording_support=1
ro.vendor.pq.mtk_hdr10p_panel_dtmo_support=1
ro.vendor.pq.mtk_hfg_support=0
ro.vendor.pq.mtk_hlg_panel_dtmo_support=0
ro.vendor.pq.mtk_hdrvivid_panel_dtmo_support=0
ro.vendor.pq.mtk_mdp_ccorr_support=0
ro.vendor.pq.mtk_mdp_lite_pq_support=0
ro.vendor.pq.mtk_mml_c3d_support=1
ro.vendor.pq.mtk_mml_color_adaptive_support=0
...
ro.vendor.pq.mtk_sdr_panel_dtmo_support=0
ro.vendor.pq.mtk_silky_brigtness_support=0
ro.vendor.pq.mtk_smart_bluelight_def_support=1
ro.vendor.pq.mtk_smart_true_tone_support=1
ro.vendor.pq.mtk_ultra_dimming_support=0
ro.vendor.pq.mtk_ultra_resolution_support=1
ro.vendor.pq.mtk_video_transition=0

# Platform
ro.vendor.mediatek.platform=MT6899
ro.vendor.mediatek.version.branch=alps-mp-v0.mp1.tc8sp4
ro.vendor.mediatek.version.release=alps-mp-v0.mp1.tc8sp4-V1
ro.vendor.mgk_name=mgk_64_k66

# Power
persist.system.powerhal.applist_enable=1
ro.vendor.magt.mtk_magt_support=1
...
ro.vendor.radio.build_region=eea
...
# Trace
debug.atrace.tags.enableflags=0x4040e
